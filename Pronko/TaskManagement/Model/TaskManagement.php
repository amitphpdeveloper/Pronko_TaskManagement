...
namespace Pronko\TaskManagement\Model;

class TaskManagement extends \Magento\Framework\Model\AbstractModel 
{

    protected $_eventPrefix = 'pronko_taskmanagement';
    ...
    {
        $this->_init(\Pronko\TaskManagement\Model\ResourceModel\TaskManagement::class);
    }
